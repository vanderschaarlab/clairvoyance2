...
If you experience bugs or general issues with `clairvoyance2`, please have a look
...
You can help improve `clairvoyance2` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`clairvoyance2` documentation uses [Sphinx] as its main documentation compiler.
...
5. Install [pre-commit]:
   ...
   `clairvoyance2` comes with a lot of hooks configured to automatically help the
